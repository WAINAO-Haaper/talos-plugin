export type ProviderSvgChild =
  | { tag: 'path'; attributes: Record<string, string> }
  | { tag: 'g'; attributes: Record<string, string>; children: ProviderSvgChild[] };

export type ProviderIconSvg =
  | { viewBox: string; path: string; kind?: undefined }
  | { kind: 'composite'; viewBox: string; children: ProviderSvgChild[] };
...
export function createProviderIconSvg(
  ...
  svg.classList.add('talos-provider-icon');
