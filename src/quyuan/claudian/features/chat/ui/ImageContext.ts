...
export class ImageContextManager {
  ...
  async pickImages(): Promise<void> {
    ...
    const picker = this.containerEl.ownerDocument.createElement('input');
    picker.type = 'file';
    picker.accept = '.jpg,.jpeg,.png,.gif,.webp,image/*';
    picker.multiple = true;
    picker.classList.add('claudian-hidden');
    this.containerEl.appendChild(picker);
