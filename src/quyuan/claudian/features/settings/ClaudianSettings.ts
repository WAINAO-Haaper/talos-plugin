...
export class ClaudianSettingTab extends PluginSettingTab {
  ...
  private renderGeneralTab(container: HTMLElement): void {
    ...
    addHotkeySettingRow(hotkeyGrid, this.app, 'talos:inline-edit', 'settings.inlineEditHotkey');
    addHotkeySettingRow(hotkeyGrid, this.app, 'talos:open-view', 'settings.openChatHotkey');
    addHotkeySettingRow(hotkeyGrid, this.app, 'talos:new-session', 'settings.newSessionHotkey');
    addHotkeySettingRow(hotkeyGrid, this.app, 'talos:new-tab', 'settings.newTabHotkey');
    addHotkeySettingRow(hotkeyGrid, this.app, 'talos:close-current-tab', 'settings.closeTabHotkey');
